...
v2f vert(a2v v)
{
	...
	float4 worldpos = mul(vertex, gModel);
	o.worldpos = worldpos.xyz;
	o.pos = mul(worldpos, gView);
	o.pos = mul(o.pos, gProj);
	o.shadowpos = mul(worldpos, gShadowTransform);
...
float4 frag(v2f i):SV_Target
{
	...
	float4 tex= gTex.Sample(gSampLinearWarp, i.uv);
	...
	float3 combinedColor = diffuse + specular+ambient;
