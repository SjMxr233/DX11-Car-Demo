...
float frag(v2f i) :SV_Target
{
	...
	float3 randVec = gRandomVecTex.Sample(gSampLinearClamp, i.uv*float2(Width, Height) / 4.0).xyz;
	...
	for (int i = 0; i < 64; i++)
	{
		...
		float3 randPos = viewPos + flip*sampleRadius * offset;
